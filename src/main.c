#include <stdio.h>
#include "../include/third-party/include/X11/Xlib.h"
...
int main(void) {
  ...
  XGrabKey(dpy, XKeysymToKeycode(dpy, XStringToKeysym("s")), Mod1Mask, DefaultRootWindow(dpy), True, GrabModeAsync, GrabModeAsync);
